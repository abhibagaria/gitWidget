...
(function () {
  ...
  function creature(){
    ...
    // Direction-native frames need no scaleX. translateY lifts the tiger on a
    // click-hop so the leap reads (the frame's own small shadow lifts with it).
    function place(){ el.style.transform='translateX('+x+'px) translateY('+(-hop)+'px)'; }
